  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_start: "day-range-start rounded-l-md aria-selected:!bg-red-500 aria-selected:!text-white",
        day_range_end: "day-range-end rounded-r-md aria-selected:!bg-green-500 aria-selected:!text-white",
